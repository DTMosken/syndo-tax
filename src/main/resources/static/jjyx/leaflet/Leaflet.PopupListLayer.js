...
(function(factory, window) {
    ...
    var PopupListLayer = L.Class.extend({
        ...
        initialize: function(options) {
            ...
            loadStyleString(".popupListLayer-wrapper .popupListLayer-title { position: absolute; top: -8px; right: 20px; }");
        ...
        mouseEventFun: function(evt) {
            ...
            if (markerList.length > 1) {
                var _contentHTml = markerList[0].options.contentHTML;
                if(typeof(_contentHTml) == 'object') {
                    _contentHTml = _contentHTml.innerHTML;
                }
                // 气泡内容
                contentHTML =
                    `<div class="popupListLayer-wrapper">
                        ...
                        <div id="popupListLayer-content" style="padding-top: 0px;">${_contentHTml}</div>
                    </div>`
            } else {
            ...
            window.leftArrowClick = function() {
                ...
                var _contentHTml = markerList[poplistsIndex - 1].options.contentHTML
                if(typeof(_contentHTml) == 'object') {
                    _contentHTml = _contentHTml.innerHTML;
                }
                document.getElementById('popupListLayer-content').innerHTML = _contentHTml
            }
            // 向右切换
